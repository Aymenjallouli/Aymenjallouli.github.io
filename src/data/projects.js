...
import { FaReact, FaNodeJs, FaRobot, FaVideo, FaMobileAlt } from 'react-icons/fa';
import {
  SiTailwindcss, SiMongodb, SiPython, SiSpringboot, SiJenkins, SiSonarqube, SiJest,
  SiExpress, SiApachekafka, SiDocker, SiCss3, SiHtml5, SiTypescript, SiVite,
  SiNextdotjs, SiJavascript,
} from 'react-icons/si';
...
export const projects = [
  {
    ...
    featured: true,
    description: {
      fr: "Plateforme de stationnement intelligent : réservation de places en temps réel, paiement intégré, tableaux de bord et architecture full-stack conteneurisée avec pipeline CI/CD.",
      en: 'Smart parking platform: real-time spot booking, integrated payments, dashboards and a containerized full-stack architecture with a CI/CD pipeline.',
    },
    image: Parkini,
    category: ['Full Stack', 'Devops'],
    technologies: [<FaReact />, <FaNodeJs />, <SiMongodb />, <SiTailwindcss />, <SiPython />],
    techNames: ['React', 'Node.js', 'MongoDB', 'TailwindCSS', 'Python'],
  ...
  },
  {
    ...
    techNames: ['Next.js', 'TypeScript', 'TailwindCSS', 'AI'],
  ...
  },
  {
    ...
    techNames: ['React', 'Node.js', 'WebRTC', 'AI'],
    private: true,
  },
  {
    id: 4,
  ...
  },
  {
    ...
    techNames: ['Spring Boot', 'Express', 'Kafka', 'Docker'],
  ...
  },
  {
    ...
    techNames: ['Jenkins', 'SonarQube', 'Docker', 'Jest'],
  ...
  // ─── Sites vitrines (clients) ───
  {
    ...
    techNames: ['HTML', 'CSS', 'JavaScript', 'Responsive'],
