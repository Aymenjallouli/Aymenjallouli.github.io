...
/** The two locales, in sitemap/hreflang order. English is the default. */
export const LOCALES = ['en', 'fr'];
export const DEFAULT_LOCALE = 'en';

/**
 * English lives at the root; French is prefixed.
 *
 * Whichever locale sits at "/" collects the inbound links and reads as the
 * primary version, so this is the one decision here with real SEO weight.
 */
