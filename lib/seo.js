import { SITE_URL, absoluteUrl, PERSON, PROJECTS_SEGMENT } from './site';
...
export const pagePaths = {
  ...
  project: (slug) => ({ fr: `/projets/${slug}`, en: `/en/projects/${slug}` }),
};
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        // x-default points at the French root: it is the URL that gets linked.
...
export function projectJsonLd(project, lang) {
  ...
  const segment = PROJECTS_SEGMENT[lang];
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: lang === 'fr' ? 'Projets' : 'Projects', item: absoluteUrl(`/${segment}`) },
